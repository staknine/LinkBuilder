defmodule LinkBuilderWeb.StripeWebhookControllerTest do
  ...
  describe "receives webhooks from stripe with correct signature and raw_body" do
    ...
    test "calls the stripe service with a sucess response", %{conn: conn} do
      post(conn, Routes.stripe_webhook_path(conn, :create), customer_created())
      assert_received {:ok, "valid_webhook"}
    end
  end

  describe "receives webhooks from stripe with incorrect" do

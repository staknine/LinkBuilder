defmodule LinkBuilder.Accounts.User do
  ...
  schema "users" do
    ...
    has_many :notifications, LinkBuilder.InAppNotifications.Notification
  ...
  defp validate_unique_email(changeset) do
    LinkBuilder.Repo.put_skip_account_id(true)
    changeset = unsafe_validate_unique(changeset, :email, LinkBuilder.Repo)

    LinkBuilder.Repo.put_skip_account_id(false)
    changeset
  end
  ...
  """
  def valid_password?(%LinkBuilder.Accounts.User{hashed_password: hashed_password}, password)
